...
namespace SyllabaryQuizGenerator.Tests
{
    ...
    {
        [DataRow(3, QuizType.EnglishToKatakana)]
        [DataRow(5, QuizType.EnglishToKatakana)]
        [DataRow(500, QuizType.EnglishToKatakana)]
        [DataRow(50000, QuizType.EnglishToKatakana)]
        [DataRow(1000000, QuizType.EnglishToKatakana)]
        [TestMethod]
        ...
        [TestMethod]
        [DataRow(10, QuizType.EnglishToKatakana)]
        [DataRow(30, QuizType.EnglishToKatakana)]
        [DataRow(40, QuizType.EnglishToKatakana)]
